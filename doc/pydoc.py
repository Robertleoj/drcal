...
extranames = dict(
    gp="https://www.github.com/dkogan/gnuplotlib",
        ...
        if (
            ...
            and (
                ...
                or (
                    ...
                    and not file.startswith(os.path.join(basedir, "dist-packages"))
...
<tr><td bgcolor="%s">%s</td><td>%s</td>"""
    ...
    def classlink(self, object, modname):
        ...
        if (
            hasattr(module, name)
            and getattr(module, name) is object
            and not re.match(r"builtins\.", classname(object, modname))
        ):

...
// Generated on 2025-09-21 12:19:51 with   scripts/triangulation-genpywrap.py

#define FUNCTIONS(_)                                                           \
    _(_triangulate_geometric,                                                  \
      "Internal geometric triangulation routine\n\nThis is the internals for " \
      "drcal.triangulate_geometric(get_gradients = False). As a\nuser, "       \
      "please call THAT function, and see the docs for that function. "        \
      "The\ndifferences:\n\n- This is just the no-gradients function. The "    \
      "internal function that returns\n  gradients is "                        \
      "_triangulate_geometric_withgrad\n\nA higher-level function "            \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_geometric_withgrad,                                         \
      "Internal geometric triangulation routine (with gradients)\n\nThis is "  \
      "the internals for drcal.triangulate_geometric(get_gradients = True). "  \
      "As a\nuser, please call THAT function, and see the docs for that "      \
      "function. The\ndifferences:\n\n- This is just the gradients-returning " \
      "function. The internal function that\n  skips those is "                \
      "_triangulate_geometric\n\nA higher-level function drcal.triangulate() " \
      "is also available for higher-level\nanalysis.\n\n")                     \
    _(_triangulate_leecivera_l1,                                               \
      "Internal Lee-Civera L1 triangulation routine\n\nThis is the internals " \
      "for drcal.triangulate_leecivera_l1(get_gradients = False). As "         \
      "a\nuser, please call THAT function, and see the docs for that "         \
      "function. The\ndifferences:\n\n- This is just the no-gradients "        \
      "function. The internal function that returns\n  gradients is "          \
      "_triangulate_leecivera_l1_withgrad\n\nA higher-level function "         \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_l1_withgrad,                                      \
      "Internal Lee-Civera L1 triangulation routine (with gradients)\n\nThis " \
      "is the internals for drcal.triangulate_leecivera_l1(get_gradients = "   \
      "True). As a\nuser, please call THAT function, and see the docs for "    \
      "that function. The\ndifferences:\n\n- This is just the "                \
      "gradients-returning function. The internal function that\n  skips "     \
      "those is _triangulate_leecivera_l1\n\nA higher-level function "         \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_linf,                                             \
      "Internal Lee-Civera L-infinity triangulation routine\n\nThis is the "   \
      "internals for drcal.triangulate_leecivera_linf(get_gradients = "        \
      "False). As a\nuser, please call THAT function, and see the docs for "   \
      "that function. The\ndifferences:\n\n- This is just the no-gradients "   \
      "function. The internal function that returns\n  gradients is "          \
      "_triangulate_leecivera_linf_withgrad\n\nA higher-level function "       \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_linf_withgrad,                                    \
      "Internal Lee-Civera L-infinity triangulation routine (with "            \
      "gradients)\n\nThis is the internals for "                               \
      "drcal.triangulate_leecivera_linf(get_gradients = True). As a\nuser, "   \
      "please call THAT function, and see the docs for that function. "        \
      "The\ndifferences:\n\n- This is just the gradients-returning function. " \
      "The internal function that\n  skips those is "                          \
      "_triangulate_leecivera_linf\n\nA higher-level function "                \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_mid2,                                             \
      "Internal Lee-Civera Mid2 triangulation routine\n\nThis is the "         \
      "internals for drcal.triangulate_leecivera_mid2(get_gradients = "        \
      "False). As a\nuser, please call THAT function, and see the docs for "   \
      "that function. The\ndifferences:\n\n- This is just the no-gradients "   \
      "function. The internal function that returns\n  gradients is "          \
      "_triangulate_leecivera_mid2_withgrad\n\nA higher-level function "       \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_mid2_withgrad,                                    \
      "Internal Lee-Civera Mid2 triangulation routine (with "                  \
      "gradients)\n\nThis is the internals for "                               \
      "drcal.triangulate_leecivera_mid2(get_gradients = True). As a\nuser, "   \
      "please call THAT function, and see the docs for that function. "        \
      "The\ndifferences:\n\n- This is just the gradients-returning function. " \
      "The internal function that\n  skips those is "                          \
      "_triangulate_leecivera_mid2\n\nA higher-level function "                \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_wmid2,                                            \
      "Internal Lee-Civera wMid2 triangulation routine\n\nThis is the "        \
      "internals for drcal.triangulate_leecivera_wmid2(get_gradients = "       \
      "False). As a\nuser, please call THAT function, and see the docs for "   \
      "that function. The\ndifferences:\n\n- This is just the no-gradients "   \
      "function. The internal function that returns\n  gradients is "          \
      "_triangulate_leecivera_wmid2_withgrad\n\nA higher-level function "      \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_leecivera_wmid2_withgrad,                                   \
      "Internal Lee-Civera wMid2 triangulation routine (with "                 \
      "gradients)\n\nThis is the internals for "                               \
      "drcal.triangulate_leecivera_wmid2(get_gradients = True). As a\nuser, "  \
      "please call THAT function, and see the docs for that function. "        \
      "The\ndifferences:\n\n- This is just the gradients-returning function. " \
      "The internal function that\n  skips those is "                          \
      "_triangulate_leecivera_wmid2\n\nA higher-level function "               \
      "drcal.triangulate() is also available for higher-level\nanalysis.\n\n") \
    _(_triangulate_lindstrom,                                                  \
      "Internal lindstrom's triangulation routine\n\nThis is the internals "   \
      "for drcal.triangulate_lindstrom(). As a user, please call\nTHAT "       \
      "function, and see the docs for that function. The differences:\n\n- "   \
      "This is just the no-gradients function. The internal function that "    \
      "returns\n  gradients is _triangulate_lindstrom_withgrad\n\n")           \
    _(_triangulate_lindstrom_withgrad,                                         \
      "Internal lindstrom's triangulation routine\n\nThis is the internals "   \
      "for drcal.triangulate_lindstrom(). As a user, please call\nTHAT "       \
      "function, and see the docs for that function. The differences:\n\n- "   \
      "This is just the gradient-returning function. The internal function "   \
      "that skips those\n  is _triangulate_lindstrom\n\n")                     \
    _(_triangulated_error,                                                     \
      "Internal triangulation routine used in the optimization loop\n\nThis "  \
      "is the internals for drcal.triangulated_error(). As a user, please "    \
      "call\nTHAT function, and see the docs for that function. The "          \
      "differences:\n\n- This is just the no-gradients function. The "         \
      "internal function that returns\n  gradients is "                        \
      "_triangulated_error_withgrad\n\n")                                      \
    _(_triangulated_error_withgrad,                                            \
      "Internal triangulation routine used in the optimization loop\n\nThis "  \
      "is the internals for drcal.triangulated_error(). As a user, please "    \
      "call\nTHAT function, and see the docs for that function. The "          \
      "differences:\n\n- This is just the gradient-returning function. The "   \
      "internal function that skips those\n  is _triangulated_error\n\n")
...
static bool parse_dim_for_one_arg(
    // input and output
    ...
    const int Ndims_want,
    const npy_intp* dims_var,
    const int Ndims_var,
    ...
    // argument must match
    for (int i_dim = -1; i_dim >= -Ndims_want; i_dim--) {
        ...
        if (dim_want != dim_var) {
            if (dims_want[i_dim_want] < 0) {
                PyErr_Format(
                    PyExc_RuntimeError,
                    "Argument '%s': prototype says dimension %d (named "
                    "dimension %d) has length %d, but got %d",
                    arg_name,
                    i_dim,
                    (int)dims_want[i_dim_want],
                    dim_want,
                    dim_var
                );
            } else {
                PyErr_Format(
                    PyExc_RuntimeError,
                    "Argument '%s': prototype says dimension %d has length %d, "
                    "but got %d",
                    arg_name,
                    i_dim,
                    dim_want,
    ...
    if (is_output) {
        for (int i_dim = -1; i_dim >= -Ndims_extra_var; i_dim--) {
            ...
            if (dim_var < dims_extra[i_dim_extra]) {
                PyErr_Format(
                    PyExc_RuntimeError,
                    "Output '%s' dimension %d (broadcasted dimension %d) too "
                    "small. Inputs have length %d but this output has length "
                    "%d",
                    arg_name,
                    i_dim - Ndims_want,
                    i_dim,
        ...
        for (int i_dim = -Ndims_extra_var - 1;
            ...
            if (dims_extra[i_dim_extra] > 1) {
                ...
                PyErr_Format(
                    PyExc_RuntimeError,
                    "Argument '%s' dimension %d (broadcasted dimension %d) is "
                    "too small: this dimension of this output is too small to "
                    "hold the broadcasted results of size %d",
                    arg_name,
                    i_dim - Ndims_want,
                    i_dim,
                    (int)dims_extra[i_dim_extra]
    ...
    for (int i_dim = -1; i_dim >= -Ndims_extra_var; i_dim--) {
        ...
        if (dim_var != 1) {
            if (i_dim_extra < 0) {
                PyErr_Format(
                    PyExc_RuntimeError,
                    "Argument '%s' dimension %d (broadcasted dimension %d) "
                    "i_dim_extra<0: %d. This shouldn't happen. There's a bug "
                    "in the implicit-leading-dimension logic. Please report",
                    arg_name,
                    i_dim - Ndims_want,
                    i_dim,
                    i_dim_extra
            ...
            if (dims_extra[i_dim_extra] == 1) {
                ...
                PyErr_Format(
                    PyExc_RuntimeError,
                    "Argument '%s' dimension %d (broadcasted dimension %d) "
                    "mismatch. Previously saw length %d, but here have length "
                    "%d",
                    arg_name,
                    i_dim - Ndims_want,
                    i_dim,
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__output; i--) {                 \
                if (strides_slice__output[i + Ndims_slice__output] !=          \
                    sizeof_element__output * Nelems_slice) {                   \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'output' must be contiguous in memory, " \
                            "and it isn't in (at least) dimension %d",         \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
                }                                                              \
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__v0; i--) {                     \
                if (strides_slice__v0[i + Ndims_slice__v0] !=                  \
                    sizeof_element__v0 * Nelems_slice) {                       \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'v0' must be contiguous in memory, and " \
                            "it isn't in (at least) dimension %d",             \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
                }                                                              \
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__v1; i--) {                     \
                if (strides_slice__v1[i + Ndims_slice__v1] !=                  \
                    sizeof_element__v1 * Nelems_slice) {                       \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'v1' must be contiguous in memory, and " \
                            "it isn't in (at least) dimension %d",             \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
    ...
    ({                                                                       \
        ...
        if (!have_dim_0) {                                                   \
            ...
            for (int i = -1; i >= -Ndims_slice__t01; i--) {                  \
                if (strides_slice__t01[i + Ndims_slice__t01] !=              \
                    sizeof_element__t01 * Nelems_slice) {                    \
                    result = false;                                          \
                    if (seterror)                                            \
                        PyErr_Format(                                        \
                            PyExc_RuntimeError,                              \
                            "Variable 't01' must be contiguous in memory, "  \
                            "and it isn't in (at least) dimension %d",       \
                            i                                                \
                        );                                                   \
                    break;                                                   \
...
#define CHECK_CONTIGUOUS_ALL()                              \
    CHECK_CONTIGUOUS__output() && CHECK_CONTIGUOUS__v0() && \
        CHECK_CONTIGUOUS__v1() && CHECK_CONTIGUOUS__t01()
#define CHECK_CONTIGUOUS_AND_SETERROR_ALL()    \
    CHECK_CONTIGUOUS_AND_SETERROR__output() && \
        CHECK_CONTIGUOUS_AND_SETERROR__v0() && \
        CHECK_CONTIGUOUS_AND_SETERROR__v1() && \
        CHECK_CONTIGUOUS_AND_SETERROR__t01()

typedef struct {
} ___triangulate_geometric__cookie_t;

static bool ___triangulate_geometric__validate(
...
#define item__output(__ivar0)               \
    (*(ctype__output*)(data_slice__output + \
                       (__ivar0) * strides_slice__output[0]))
#define ctype__v0 npy_float64
#define item__v0(__ivar0) \
    (*(ctype__v0*)(data_slice__v0 + (__ivar0) * strides_slice__v0[0]))
#define ctype__v1 npy_float64
#define item__v1(__ivar0) \
    (*(ctype__v1*)(data_slice__v1 + (__ivar0) * strides_slice__v1[0]))
#define ctype__t01 npy_float64
#define item__t01(__ivar0) \
    (*(ctype__t01*)(data_slice__t01 + (__ivar0) * strides_slice__t01[0]))

static bool ___triangulate_geometric__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output =
        drcal_triangulate_geometric(NULL, NULL, NULL, v0, v1, t01);
    return true;
}
#undef item__output
#undef ctype__output
...
#define ARGLIST_SELECTED_TYPENUM_PTR_DECLARE(name) \
    int *selected_typenum__##name,
#define ARGLIST_SELECTED_TYPENUM_PTR_CALL(name) &selected_typenum__##name,

#define SLICE_ARG(name)                                                    \
                                                                           \
    const int Ndims_full__##name, const npy_intp *dims_full__##name,       \
        const npy_intp *strides_full__##name,                              \
                                                                           \
        const int Ndims_slice__##name, const npy_intp *dims_slice__##name, \
        const npy_intp *strides_slice__##name,                             \
                                                                           \
        npy_intp sizeof_element__##name, void *data_slice__##name,

static bool __pywrap___triangulate_geometric__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
    for (int i = N - 1; i >= 0; i--) {
        if (++idims[i] < Ndims[i]) {
...
bool __pywrap___triangulate_geometric__type_matches(
    ARGUMENTS(TYPE_MATCHES_ARGLIST) OUTPUTS(TYPE_MATCHES_ARGLIST)
        ARGUMENTS(ARGLIST_DECLARE) OUTPUTS(ARGLIST_DECLARE)
            OUTPUTS(ARGLIST_SELECTED_TYPENUM_PTR_DECLARE) int dummy
    __attribute__((unused))
) {
#define SET_SELECTED_TYPENUM_OUTPUT(name) \
    *selected_typenum__##name = typenum__##name;
#define TYPE_MATCHES(name)                                           \
    &&(__py__##name == NULL || (PyObject*)__py__##name == Py_None || \
...
static PyObject* __pywrap___triangulate_geometric(
    ...
    typedef bool(slice_function_t)(
        OUTPUTS(SLICE_ARG) ARGUMENTS(SLICE_ARG)
            ___triangulate_geometric__cookie_t *
        cookie __attribute__((unused))
    );
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_geometric",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define TYPESETS(_) _(12, 12, 12, 12, 0)
#define TYPESET_MATCHES(t0, t1, t2, t3, i)                       \
                 ...
                 t2,                                             \
                 t3,                                             \
                 ARGUMENTS(ARGLIST_CALL) OUTPUTS(ARGLIST_CALL)   \
...
#define INPUT_TYPEOBJ(name)                                         \
    , (((PyObject*)__py__##name != Py_None && __py__##name != NULL) \
           ? (PyObject*)PyArray_DESCR(__py__##name)->typeobj        \
           : (PyObject*)Py_None)

            PyErr_Format(
                PyExc_RuntimeError,
                "The set of input and output types must correspond to one of "
                "these sets:\n"
                ...
                "instead I got types (inputs: " ARGUMENTS(INPUT_PERCENT_S
                  ...
                  "   outputs: (" OUTPUTS(INPUT_PERCENT_S
                    ...
                    "None in an output is not an error: a new array of the "
                    "right type will be created" ARGUMENTS(INPUT_TYPEOBJ)
...
#undef TYPESET_MATCHES
        ...
        // later, I make copies with actual "1" values in place. I do that
        // because:
        //
...
#define DECLARE_DIM_VARS(name)                                       \
    const int PROTOTYPE_LEN_##name =                                 \
        (int)sizeof(PROTOTYPE_##name) / sizeof(PROTOTYPE_##name[0]); \
    int __ndim__##name = -1;                                         \
    ...
    for (int i = 0; i < PROTOTYPE_LEN_##name; i++)                           \
        if (PROTOTYPE_##name[i] < 0 &&                                       \
            ...
            PyErr_Format(                                                    \
                ...
                " dimension %d is named, but not defined by the input. You " \
                "MUST pass in-place output array(s) to define these "        \
                "dimensions",                                                \
                i                                                            \
            );                                                               \
            goto done;                                                       \
        ...
        // The dimensions of each output must be (dims_extra +
        // PROTOTYPE__output__)
#define CREATE_MISSING_OUTPUT(name)                                      \
    if ((PyObject*)__py__##name == Py_None || __py__##name == NULL) {    \
        ...
        for (int i = 0; i < PROTOTYPE_LEN_##name; i++)                   \
            if (PROTOTYPE_##name[i] < 0)                                 \
                dims_output_want[i + Ndims_extra] =                      \
                    dims_named[-PROTOTYPE_##name[i] - 1];                \
        ...
        __py__##name = (PyArrayObject*)PyArray_SimpleNew(                \
            Ndims_output,                                                \
            dims_output_want,                                            \
            selected_typenum__##name                                     \
        );                                                               \
        if (__py__##name == NULL) {                                      \
...
#define MAKE_MOUNTED_COPIES(name)                                         \
    ...
    {                                                                     \
        ...
        for (; i_dim >= -__ndim__##name; i_dim--) {                       \
            ...
            __dims__mounted__##name[i_dim + __ndim__mounted__##name] =    \
                __dims__##name[i_dim + __ndim__##name];                   \
            __strides__mounted__##name[i_dim + __ndim__mounted__##name] = \
                __strides__##name[i_dim + __ndim__##name];                \
        }                                                                 \
    ...
    int Ndims_extra__mounted__##name =                                    \
        __ndim__mounted__##name - PROTOTYPE_LEN_##name;                   \
                                                                          \
...
#define ARGLIST_CALL_USER_CALLBACK(name)                           \
    __ndim__mounted__##name, __dims__mounted__##name,              \
        ...
        PyArray_ITEMSIZE(__py__##name), (void*)data_argument__##name,

#define DEFINE_DATA_ARGUMENT(name) char* data_argument__##name;
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_geometric__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
                    PyExc_RuntimeError,
                    "User-provided validation failed!"
                );
            }
            goto done;
        }
...
#undef INIT_DATA_ARGUMENT
            ...
            for (int i_dim = -1; i_dim >= -Ndims_extra; i_dim--) {
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        data_argument__##name +=                                            \
            idims_extra[i_dim + Ndims_extra] *                              \
            __strides__##name[i_dim + Ndims_extra__mounted__##name];
        ...
        } while (__pywrap___triangulate_geometric__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__output0; i--) {                \
                if (strides_slice__output0[i + Ndims_slice__output0] !=        \
                    sizeof_element__output0 * Nelems_slice) {                  \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'output0' must be contiguous in "        \
                            "memory, and it isn't in (at least) dimension %d", \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
                }                                                              \
...
#define CHECK_CONTIGUOUS_AND_SETERROR__output0() \
    _CHECK_CONTIGUOUS__output0(true)
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__output1; i--) {                \
                if (strides_slice__output1[i + Ndims_slice__output1] !=        \
                    sizeof_element__output1 * Nelems_slice) {                  \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'output1' must be contiguous in "        \
                            "memory, and it isn't in (at least) dimension %d", \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
...
#define CHECK_CONTIGUOUS_AND_SETERROR__output1() \
    _CHECK_CONTIGUOUS__output1(true)
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__output2; i--) {                \
                if (strides_slice__output2[i + Ndims_slice__output2] !=        \
                    sizeof_element__output2 * Nelems_slice) {                  \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'output2' must be contiguous in "        \
                            "memory, and it isn't in (at least) dimension %d", \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
...
#define CHECK_CONTIGUOUS_AND_SETERROR__output2() \
    _CHECK_CONTIGUOUS__output2(true)
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__output3; i--) {                \
                if (strides_slice__output3[i + Ndims_slice__output3] !=        \
                    sizeof_element__output3 * Nelems_slice) {                  \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'output3' must be contiguous in "        \
                            "memory, and it isn't in (at least) dimension %d", \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
...
#define CHECK_CONTIGUOUS_AND_SETERROR__output3() \
    _CHECK_CONTIGUOUS__output3(true)
...
#define CHECK_CONTIGUOUS_ALL()                                        \
    CHECK_CONTIGUOUS__output0() && CHECK_CONTIGUOUS__output1() &&     \
        CHECK_CONTIGUOUS__output2() && CHECK_CONTIGUOUS__output3() && \
        CHECK_CONTIGUOUS__v0() && CHECK_CONTIGUOUS__v1() &&           \
        CHECK_CONTIGUOUS__t01()
#define CHECK_CONTIGUOUS_AND_SETERROR_ALL()         \
    CHECK_CONTIGUOUS_AND_SETERROR__output0() &&     \
        CHECK_CONTIGUOUS_AND_SETERROR__output1() && \
        CHECK_CONTIGUOUS_AND_SETERROR__output2() && \
        CHECK_CONTIGUOUS_AND_SETERROR__output3() && \
        CHECK_CONTIGUOUS_AND_SETERROR__v0() &&      \
        CHECK_CONTIGUOUS_AND_SETERROR__v1() &&      \
        CHECK_CONTIGUOUS_AND_SETERROR__t01()

typedef struct {
} ___triangulate_geometric_withgrad__cookie_t;

static bool ___triangulate_geometric_withgrad__validate(
...
#define item__output0(__ivar0)                \
    (*(ctype__output0*)(data_slice__output0 + \
                        (__ivar0) * strides_slice__output0[0]))
#define ctype__output1 npy_float64
#define item__output1(__ivar0, __ivar1)                         \
    (*(ctype__output1*)(data_slice__output1 +                   \
                        (__ivar0) * strides_slice__output1[0] + \
                        (__ivar1) * strides_slice__output1[1]))
#define ctype__output2 npy_float64
#define item__output2(__ivar0, __ivar1)                         \
    (*(ctype__output2*)(data_slice__output2 +                   \
                        (__ivar0) * strides_slice__output2[0] + \
                        (__ivar1) * strides_slice__output2[1]))
#define ctype__output3 npy_float64
#define item__output3(__ivar0, __ivar1)                         \
    (*(ctype__output3*)(data_slice__output3 +                   \
                        (__ivar0) * strides_slice__output3[0] + \
                        (__ivar1) * strides_slice__output3[1]))
#define ctype__v0 npy_float64
#define item__v0(__ivar0) \
    (*(ctype__v0*)(data_slice__v0 + (__ivar0) * strides_slice__v0[0]))
#define ctype__v1 npy_float64
...
static bool ___triangulate_geometric_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output0 =
        drcal_triangulate_geometric(dm_dv0, dm_dv1, dm_dt01, v0, v1, t01);
    return true;
}
#undef item__output0
...
static bool __pywrap___triangulate_geometric_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_geometric_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_geometric_withgrad",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
    ...
    if (__py__output__arg == NULL) {
        ...
        if (__py__output__arg == NULL) {
            PyErr_Format(
                PyExc_RuntimeError,
                "Could not allocate output tuple of length %d",
                4
            );
            goto done;
        }

        // I made a tuple, but I don't yet have arrays to populate it with. I'll
        // make those later, and I'll fill the tuple later
        ...
        if (!PySequence_Check(__py__output__arg)) {
            PyErr_Format(
                PyExc_RuntimeError,
                "Have multiple outputs. The given 'out' argument is expected "
                "to be a sequence of length %d, but a non-sequence was given",
                4
            );
            goto done;
        }
        if (PySequence_Size(__py__output__arg) != 4) {
            PyErr_Format(
                PyExc_RuntimeError,
                "Have multiple outputs. The given 'out' argument is expected "
                "to be a sequence of length %d, but a sequence of length %d "
                "was given",
                4,
                PySequence_Size(__py__output__arg)
            );
            goto done;
        }
...
#define PULL_OUT_OUTPUT_ARRAYS(name)                                           \
    ...
    if (__py__##name == NULL || !PyArray_Check(__py__##name)) {                \
        PyErr_SetString(                                                       \
            PyExc_RuntimeError,                                                \
            "Have multiple outputs. The given 'out' array MUST contain "       \
            "pre-allocated arrays, but " #name " is not an array"              \
        );                                                                     \
        goto done;                                                             \
    }
        int i = 0;
...
#define TYPESETS(_) _(12, 12, 12, 12, 12, 12, 12, 0)
    ...
    , (((PyObject*)__py__##name != Py_None && __py__##name != NULL) \
           ...
           : (PyObject*)Py_None)
            ...
            PyErr_Format(
                ...
                "The set of input and output types must correspond to one of "
                "these sets:\n"
                "  (inputs: float64,float64,float64   outputs: "
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_geometric_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_geometric_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_l1__cookie_t;

static bool ___triangulate_leecivera_l1__validate(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
...
static bool ___triangulate_leecivera_l1__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output =
        drcal_triangulate_leecivera_l1(NULL, NULL, NULL, v0, v1, t01);
    return true;
}
#undef item__output
#undef ctype__output
...
static bool __pywrap___triangulate_leecivera_l1__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_l1(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_leecivera_l1",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_l1__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_l1__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_l1_withgrad__cookie_t;

static bool ___triangulate_leecivera_l1_withgrad__validate(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    npy_intp sizeof_element__t01 __attribute__((unused)),
    void* data__t01 __attribute__((unused)),
    ___triangulate_leecivera_l1_withgrad__cookie_t* cookie
    __attribute__((unused))
) {
    return CHECK_CONTIGUOUS_AND_SETERROR_ALL();
}
...
static bool ___triangulate_leecivera_l1_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output0 =
        drcal_triangulate_leecivera_l1(dm_dv0, dm_dv1, dm_dt01, v0, v1, t01);
    return true;
}
#undef item__output0
#undef ctype__output0
...
static bool __pywrap___triangulate_leecivera_l1_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_l1_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_leecivera_l1_withgrad",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_l1_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_l1_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_linf__cookie_t;

static bool ___triangulate_leecivera_linf__validate(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
...
static bool ___triangulate_leecivera_linf__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output =
        drcal_triangulate_leecivera_linf(NULL, NULL, NULL, v0, v1, t01);
    return true;
}
#undef item__output
#undef ctype__output
...
static bool __pywrap___triangulate_leecivera_linf__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_linf(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_leecivera_linf",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_linf__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_linf__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_linf_withgrad__cookie_t;

static bool ___triangulate_leecivera_linf_withgrad__validate(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    npy_intp sizeof_element__t01 __attribute__((unused)),
    void* data__t01 __attribute__((unused)),
    ___triangulate_leecivera_linf_withgrad__cookie_t* cookie
    __attribute__((unused))
) {
    return CHECK_CONTIGUOUS_AND_SETERROR_ALL();
}
...
static bool ___triangulate_leecivera_linf_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output0 =
        drcal_triangulate_leecivera_linf(dm_dv0, dm_dv1, dm_dt01, v0, v1, t01);
    return true;
}
#undef item__output0
#undef ctype__output0
...
static bool __pywrap___triangulate_leecivera_linf_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_linf_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE) "|O"
                                 ":bindings_triangulation_npsp._triangulate_"
                                 "leecivera_linf_withgrad",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_linf_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_linf_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_mid2__cookie_t;

static bool ___triangulate_leecivera_mid2__validate(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
...
static bool ___triangulate_leecivera_mid2__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output =
        drcal_triangulate_leecivera_mid2(NULL, NULL, NULL, v0, v1, t01);
    return true;
}
#undef item__output
#undef ctype__output
...
static bool __pywrap___triangulate_leecivera_mid2__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_mid2(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_leecivera_mid2",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_mid2__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_mid2__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_mid2_withgrad__cookie_t;

static bool ___triangulate_leecivera_mid2_withgrad__validate(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    npy_intp sizeof_element__t01 __attribute__((unused)),
    void* data__t01 __attribute__((unused)),
    ___triangulate_leecivera_mid2_withgrad__cookie_t* cookie
    __attribute__((unused))
) {
    return CHECK_CONTIGUOUS_AND_SETERROR_ALL();
}
...
static bool ___triangulate_leecivera_mid2_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output0 =
        drcal_triangulate_leecivera_mid2(dm_dv0, dm_dv1, dm_dt01, v0, v1, t01);
    return true;
}
#undef item__output0
#undef ctype__output0
...
static bool __pywrap___triangulate_leecivera_mid2_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_mid2_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_mid2_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_mid2_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_wmid2__cookie_t;

static bool ___triangulate_leecivera_wmid2__validate(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
...
static bool ___triangulate_leecivera_wmid2__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output =
        drcal_triangulate_leecivera_wmid2(NULL, NULL, NULL, v0, v1, t01);
    return true;
}
#undef item__output
#undef ctype__output
...
static bool __pywrap___triangulate_leecivera_wmid2__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_wmid2(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_leecivera_wmid2",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_wmid2__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_wmid2__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulate_leecivera_wmid2_withgrad__cookie_t;

static bool ___triangulate_leecivera_wmid2_withgrad__validate(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    npy_intp sizeof_element__t01 __attribute__((unused)),
    void* data__t01 __attribute__((unused)),
    ___triangulate_leecivera_wmid2_withgrad__cookie_t* cookie
    __attribute__((unused))
) {
    return CHECK_CONTIGUOUS_AND_SETERROR_ALL();
}
...
static bool ___triangulate_leecivera_wmid2_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output0 =
        drcal_triangulate_leecivera_wmid2(dm_dv0, dm_dv1, dm_dt01, v0, v1, t01);
    return true;
}
#undef item__output0
#undef ctype__output0
...
static bool __pywrap___triangulate_leecivera_wmid2_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_leecivera_wmid2_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define TYPESET_MATCHES(t0, t1, t2, t3, t4, t5, t6, i)                      \
        ...
        /* matched */                                                       \
        slice_function =                                                    \
            ___triangulate_leecivera_wmid2_withgrad__##i##__slice;          \
    }
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_leecivera_wmid2_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_leecivera_wmid2_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__v0_local; i--) {               \
                if (strides_slice__v0_local[i + Ndims_slice__v0_local] !=      \
                    sizeof_element__v0_local * Nelems_slice) {                 \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'v0_local' must be contiguous in "       \
                            "memory, and it isn't in (at least) dimension %d", \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
                ...
                Nelems_slice *=                                                \
                    dims_slice__v0_local[i + Ndims_slice__v0_local];           \
            }                                                                  \
        }                                                                      \
        result;                                                                \
    })
#define CHECK_CONTIGUOUS__v0_local() _CHECK_CONTIGUOUS__v0_local(false)
#define CHECK_CONTIGUOUS_AND_SETERROR__v0_local() \
    _CHECK_CONTIGUOUS__v0_local(true)
    ...
    ({                                                                         \
        ...
        if (!have_dim_0) {                                                     \
            ...
            for (int i = -1; i >= -Ndims_slice__v1_local; i--) {               \
                if (strides_slice__v1_local[i + Ndims_slice__v1_local] !=      \
                    sizeof_element__v1_local * Nelems_slice) {                 \
                    result = false;                                            \
                    if (seterror)                                              \
                        PyErr_Format(                                          \
                            PyExc_RuntimeError,                                \
                            "Variable 'v1_local' must be contiguous in "       \
                            "memory, and it isn't in (at least) dimension %d", \
                            i                                                  \
                        );                                                     \
                    break;                                                     \
                ...
                Nelems_slice *=                                                \
                    dims_slice__v1_local[i + Ndims_slice__v1_local];           \
            }                                                                  \
        }                                                                      \
        result;                                                                \
    })
#define CHECK_CONTIGUOUS__v1_local() _CHECK_CONTIGUOUS__v1_local(false)
#define CHECK_CONTIGUOUS_AND_SETERROR__v1_local() \
    _CHECK_CONTIGUOUS__v1_local(true)
    ...
    ({                                                                       \
        ...
        if (!have_dim_0) {                                                   \
            ...
            for (int i = -1; i >= -Ndims_slice__Rt01; i--) {                 \
                if (strides_slice__Rt01[i + Ndims_slice__Rt01] !=            \
                    sizeof_element__Rt01 * Nelems_slice) {                   \
                    result = false;                                          \
                    if (seterror)                                            \
                        PyErr_Format(                                        \
                            PyExc_RuntimeError,                              \
                            "Variable 'Rt01' must be contiguous in memory, " \
                            "and it isn't in (at least) dimension %d",       \
                            i                                                \
                        );                                                   \
                    break;                                                   \
...
#define CHECK_CONTIGUOUS_ALL()                                    \
    CHECK_CONTIGUOUS__output() && CHECK_CONTIGUOUS__v0_local() && \
        CHECK_CONTIGUOUS__v1_local() && CHECK_CONTIGUOUS__Rt01()
#define CHECK_CONTIGUOUS_AND_SETERROR_ALL()          \
    CHECK_CONTIGUOUS_AND_SETERROR__output() &&       \
        CHECK_CONTIGUOUS_AND_SETERROR__v0_local() && \
        CHECK_CONTIGUOUS_AND_SETERROR__v1_local() && \
        CHECK_CONTIGUOUS_AND_SETERROR__Rt01()

typedef struct {
} ___triangulate_lindstrom__cookie_t;

static bool ___triangulate_lindstrom__validate(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
...
#define item__v0_local(__ivar0)                 \
    (*(ctype__v0_local*)(data_slice__v0_local + \
                         (__ivar0) * strides_slice__v0_local[0]))
#define ctype__v1_local npy_float64
#define item__v1_local(__ivar0)                 \
    (*(ctype__v1_local*)(data_slice__v1_local + \
                         (__ivar0) * strides_slice__v1_local[0]))
#define ctype__Rt01 npy_float64
#define item__Rt01(__ivar0, __ivar1)                                         \
    (*(ctype__Rt01*)(data_slice__Rt01 + (__ivar0) * strides_slice__Rt01[0] + \
                     (__ivar1) * strides_slice__Rt01[1]))

static bool ___triangulate_lindstrom__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output =
        drcal_triangulate_lindstrom(NULL, NULL, NULL, v0, v1, Rt01);
    return true;
}
#undef item__output
#undef ctype__output
...
static bool __pywrap___triangulate_lindstrom__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_lindstrom(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_lindstrom",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_lindstrom__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_lindstrom__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
#define CHECK_CONTIGUOUS_ALL()                                          \
    CHECK_CONTIGUOUS__output0() && CHECK_CONTIGUOUS__output1() &&       \
        CHECK_CONTIGUOUS__output2() && CHECK_CONTIGUOUS__output3() &&   \
        CHECK_CONTIGUOUS__v0_local() && CHECK_CONTIGUOUS__v1_local() && \
        CHECK_CONTIGUOUS__Rt01()
#define CHECK_CONTIGUOUS_AND_SETERROR_ALL()          \
    CHECK_CONTIGUOUS_AND_SETERROR__output0() &&      \
        CHECK_CONTIGUOUS_AND_SETERROR__output1() &&  \
        CHECK_CONTIGUOUS_AND_SETERROR__output2() &&  \
...
typedef struct {
} ___triangulate_lindstrom_withgrad__cookie_t;

static bool ___triangulate_lindstrom_withgrad__validate(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
...
#define item__output2(__ivar0, __ivar1)                         \
    (*(ctype__output2*)(data_slice__output2 +                   \
                        ...
                        (__ivar1) * strides_slice__output2[1]))
#define ctype__output3 npy_float64
#define item__output3(__ivar0, __ivar1, __ivar2)                \
    (*(ctype__output3*)(data_slice__output3 +                   \
                        (__ivar0) * strides_slice__output3[0] + \
                        (__ivar1) * strides_slice__output3[1] + \
                        (__ivar2) * strides_slice__output3[2]))
#define ctype__v0_local npy_float64
#define item__v0_local(__ivar0)                 \
    (*(ctype__v0_local*)(data_slice__v0_local + \
                         (__ivar0) * strides_slice__v0_local[0]))
...
static bool ___triangulate_lindstrom_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(drcal_point3_t*)data_slice__output0 =
        drcal_triangulate_lindstrom(dm_dv0, dm_dv1, dm_dRt01, v0, v1, Rt01);
    return true;
}
#undef item__output0
#undef ctype__output0
...
static bool __pywrap___triangulate_lindstrom_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulate_lindstrom_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulate_lindstrom_withgrad",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulate_lindstrom_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulate_lindstrom_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
typedef struct {
} ___triangulated_error__cookie_t;

static bool ___triangulated_error__validate(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
...
static bool ___triangulated_error__0__slice(
    const int Ndims_full__output __attribute__((unused)),
    const npy_intp* dims_full__output __attribute__((unused)),
    const npy_intp* strides_full__output __attribute__((unused)),
    const int Ndims_slice__output __attribute__((unused)),
    ...
    *(double*)data_slice__output =
        _drcal_triangulated_error(NULL, NULL, v0, v1, t01);
    return true;
}
#undef item__output
#undef ctype__output
...
static bool __pywrap___triangulated_error__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulated_error(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulated_error",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulated_error__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
#define CHECK_CONTIGUOUS_ALL()                                    \
    CHECK_CONTIGUOUS__output0() && CHECK_CONTIGUOUS__output1() && \
        CHECK_CONTIGUOUS__output2() && CHECK_CONTIGUOUS__v0() &&  \
        CHECK_CONTIGUOUS__v1() && CHECK_CONTIGUOUS__t01()
#define CHECK_CONTIGUOUS_AND_SETERROR_ALL()         \
    CHECK_CONTIGUOUS_AND_SETERROR__output0() &&     \
        CHECK_CONTIGUOUS_AND_SETERROR__output1() && \
...
typedef struct {
} ___triangulated_error_withgrad__cookie_t;

static bool ___triangulated_error_withgrad__validate(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
...
#define ctype__output1 npy_float64
#define item__output1(__ivar0)                \
    (*(ctype__output1*)(data_slice__output1 + \
                        (__ivar0) * strides_slice__output1[0]))
#define ctype__output2 npy_float64
#define item__output2(__ivar0)                \
    (*(ctype__output2*)(data_slice__output2 + \
                        (__ivar0) * strides_slice__output2[0]))
#define ctype__v0 npy_float64
#define item__v0(__ivar0) \
...
static bool ___triangulated_error_withgrad__0__slice(
    const int Ndims_full__output0 __attribute__((unused)),
    const npy_intp* dims_full__output0 __attribute__((unused)),
    const npy_intp* strides_full__output0 __attribute__((unused)),
    const int Ndims_slice__output0 __attribute__((unused)),
    ...
    *(double*)data_slice__output0 =
        _drcal_triangulated_error(derr_dv1, derr_dt01, v0, v1, t01);
    return true;
}
#undef item__output0
#undef ctype__output0
...
static bool __pywrap___triangulated_error_withgrad__next(
    int* idims,
    const npy_intp* Ndims,
    int N
) {
...
static PyObject* __pywrap___triangulated_error_withgrad(
    PyObject* NPY_UNUSED(self),
    PyObject* args,
    PyObject* kwargs
) {
...
#define PARSEARG(name) PyArray_Converter, &__py__##name,
    if (!PyArg_ParseTupleAndKeywords(
            ...
            ARGUMENTS(PARSECODE
              ...
              ":bindings_triangulation_npsp._triangulated_error_withgrad",
            keywords,
            ARGUMENTS(PARSEARG) & __py__output__arg,
...
#define TYPESETS(_) _(12, 12, 12, 12, 12, 12, 0)
...
#define INIT_DATA_ARGUMENT(name) \
    data_argument__##name = PyArray_DATA(__py__##name);
        ...
        if (!___triangulated_error_withgrad__validate(OUTPUTS(
                ARGLIST_CALL_USER_CALLBACK
            ) ARGUMENTS(ARGLIST_CALL_USER_CALLBACK) cookie)) {
            if (PyErr_Occurred() == NULL) {
                PyErr_SetString(
...
#define ADVANCE_SLICE(name)                                                 \
    if (i_dim + Ndims_extra__mounted__##name >= 0 &&                        \
        ...
        } while (__pywrap___triangulated_error_withgrad__next(
            idims_extra,
            dims_extra,
            Ndims_extra
        ));
...
static PyMethodDef methods[] = {FUNCTIONS(PYMETHODDEF_ENTRY){}};

#if PY_MAJOR_VERSION == 2

PyMODINIT_FUNC initbindings_triangulation_npsp(
    void
) {
    Py_InitModule3(
        "bindings_triangulation_npsp",
        methods,
        "Internal triangulation routines\n\nThis is the written-in-C Python "
        "extension module that underlies the\ntriangulation routines. The "
        "user-facing functions are available in\ndrcal.triangulation module in "
        "drcal/triangulation.py\n\nAll functions are exported into the drcal "
        "module. So you can call these via\ndrcal._triangulation_npsp.fff() or "
        "drcal.fff(). The latter is preferred.\n\n"
    );
    import_array();
}
...
PyMODINIT_FUNC PyInit_bindings_triangulation_npsp(
    void
) {

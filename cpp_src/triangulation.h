...
drcal_point3_t drcal_triangulate_geometric(  // outputs
                                             // These all may be NULL
    drcal_point3_t* dm_dv0,
    drcal_point3_t* dm_dv1,
    drcal_point3_t* dm_dt01,
    ...
    const drcal_point3_t* v1,
    const drcal_point3_t* t01
);
...
drcal_point3_t drcal_triangulate_lindstrom(  // outputs
                                             // These all may be NULL
    drcal_point3_t* dm_dv0,
    drcal_point3_t* dm_dv1,
    drcal_point3_t* dm_dRt01,
    ...
    const drcal_point3_t* v0_local,
    const drcal_point3_t* v1_local,
    const drcal_point3_t* Rt01
);
...
drcal_point3_t drcal_triangulate_leecivera_l1(  // outputs
                                                // These all may be NULL
    drcal_point3_t* dm_dv0,
    drcal_point3_t* dm_dv1,
    drcal_point3_t* dm_dt01,
...
drcal_point3_t drcal_triangulate_leecivera_linf(  // outputs
                                                  // These all may be NULL
    drcal_point3_t* dm_dv0,
    drcal_point3_t* dm_dv1,
    drcal_point3_t* dm_dt01,
...
// Civera. https://arxiv.org/abs/1907.11917
drcal_point3_t drcal_triangulate_leecivera_mid2(  // outputs
                                                  // These all may be NULL
    drcal_point3_t* dm_dv0,
    drcal_point3_t* dm_dv1,
    drcal_point3_t* dm_dt01,
...
drcal_point3_t drcal_triangulate_leecivera_wmid2(  // outputs
                                                   // These all may be NULL
    drcal_point3_t* dm_dv0,
    drcal_point3_t* dm_dv1,
    drcal_point3_t* dm_dt01,
...
double _drcal_triangulated_error(  // outputs
...
bool _drcal_triangulate_leecivera_mid2_is_convergent(  // inputs

...
This is the internals for drcal.triangulate_{WHAT}(get_gradients = False). As a
...
This is the internals for drcal.triangulate_{WHAT}(get_gradients = True). As a
user, please call THAT function, and see the docs for that function. The
differences:
...
BODY_SLICE = r"""
                ...
                *(drcal_point3_t*)data_slice__output =
                  drcal_triangulate_{WHAT}(NULL, NULL, NULL,
                                           v0, v1, t01);
                return true;
"""
BODY_SLICE_WITHGRAD = r"""
                ...
                *(drcal_point3_t*)data_slice__output0 =
                  drcal_triangulate_{WHAT}( dm_dv0, dm_dv1, dm_dt01,
                                            v0, v1, t01);
                return true;
"""
common_kwargs = dict(
